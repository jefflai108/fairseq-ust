...
RESULTS_PATH=/data/sls/scratch/clai24/lexicon/exp/textless_s2ut_gen/${SRC}-${TGT}_v0-train_mined_t1.07_filter${L}_subset0.1_u2u_diag.align.probt${LEXICON_T}_beam${BEAM}/
#######################################################################
