...
if __name__ == '__main__':
    ...
    src_audio_loc = 'en_aud.zip:74:23029'
    feat = get_features_or_waveform(os.path.join(audio_src_pth, src_audio_loc), need_waveform=True, use_sample_rate=16000)
    print("extract waveform with feat shape", feat.shape)
