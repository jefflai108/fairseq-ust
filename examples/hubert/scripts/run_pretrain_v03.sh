#!/bin/bash
#SBATCH -J InfoA.v3
#SBATCH -o /data/sls/scratch/clai24/lexicon/exp/slurm_dump/s2u_en.v03.pretrainedmHubert.6LuDecoder.100k.lr5e-4_%j.out   
#SBATCH -e /data/sls/scratch/clai24/lexicon/exp/slurm_dump/s2u_en.v03.pretrainedmHubert.6LuDecoder.100k.lr5e-4_%j.err   
#SBATCH --qos=regular 
#SBATCH --gres=gpu:4
#SBATCH --nodes=1 
...
expname=s2u_en.v03.pretrainedmHubert.6LuDecoder.100k.lr5e-4
