...
@register_task("token_lexical_unit_to_unit")
class TokenLexicalSpeechToSpeechTask(LegacyFairseqTask):
    @classmethod
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        if len(self.multitask_tasks) > 0:
            from fairseq.models.unit_to_unit.token_lex_u2u_transformer import (
                TokenLexU2UTransformerMultitaskModelBase,
            )

            assert isinstance(model, TokenLexU2UTransformerMultitaskModelBase)
